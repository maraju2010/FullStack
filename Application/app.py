...
class Middleware(database):
    ...
    def query(self,args,type):
        ...
        if type == "MU":
            sql = "select * from Machine where UserId = %s"
        if type == "MM":
...
class _parser(object):
    ...
    def verify_1(self,row):
        ...
        logger._write("setting line map for orig_user: %s" % self.orig_user,debugtype="DEBUG")
    ...
    def verify_2(self,row):
        ...
        self.new_machine = row[0]['MachineId']
